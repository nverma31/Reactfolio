...
const Footer = ({ activeElem, setActiveElem }) => {
  return (
    <div className="flex bedar-sm:items-center justify-between flex-col bedar-sm:flex-row gap-1 bedar-sm:gap-0 px-5 bedar-sc1:px-20 py-5 mt-10">
      <div className="w-[96%] mx-auto border-t border-gray-300 pt-5 flex bedar-sm:items-center justify-between flex-col bedar-sm:flex-row gap-1 bedar-sm:gap-0">
