      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-12">
        {randomProjects.map((project) => (
          <Link 
            ...
            className="block"
          >
            <div className="bg-white border border-zinc-200 hover:bg-white rounded-2xl hover:shadow-lg transition-all duration-300 ease-in-out py-4 px-4 md:py-8 md:px-6 lg:py-10 lg:px-8 max-w-4xl w-full flex flex-col md:flex-row items-stretch hover:scale-105">
              {/* Left Text Section */}
              <div className="md:w-[40vw] w-full text-center md:text-left mb-2 md:mb-0 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-center md:justify-start">
                  <span className="bg-gray-100 hover:bg-gray-200 text-gray-600 font-medium py-2 px-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 ease-in-out flex items-center justify-center md:justify-start mx-auto md:mx-0 group text-base max-w-[140px] font-['Satoshi'] hover:scale-105">
                    Read More
                    <svg 
              ...
              {/* Right Image Section */}
              <div className="md:w-[65vw] w-full flex justify-center items-center mt-2 md:mt-0">
