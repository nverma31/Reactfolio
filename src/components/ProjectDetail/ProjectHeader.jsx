...
const ProjectHeader = ({ projectName, timeline, platform, role }) => {
  return (
    <header className="mb-12 lg:w-[70%]">
      <h1 className="text-6xl font-semibold leading-tight mb-8 font-inter-tight">{projectName}</h1>
